...
async def digital_models_new(info: Request):
    ...
    options = {
        ...
        "environment": {
            ...
            "DIGITAL_MODEL_RETRAINING_BEST_EPOCH": int(info_json["DIGITAL_MODEL_RETRAINING_BEST_EPOCH"]),
            "DIGITAL_MODEL_RETRAINING_RETRAIN_WEIGHTS": int(info_json["DIGITAL_MODEL_RETRAINING_RETRAIN_WEIGHTS"]),
